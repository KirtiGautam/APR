...
class Video(models.Model):
    ...
    viewed_by = models.ManyToManyField(
        User, related_name='user_viewed_assignment_videos')
...
class Pdf(models.Model):
    ...
    created = models.DateTimeField(auto_now_add=True)
    viewed_by = models.ManyToManyField(
        User, related_name='user_viewed_assignment_pdfs')
...
class pdfAComment(models.Model):
    Pdf = models.ForeignKey(
        Pdf, related_name='comments', on_delete=models.CASCADE)
    Author = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name='assignment_pdf_comments')
    body = models.TextField()
    likes = models.ManyToManyField(User, through='assignment_pdf_likes')
    doubt = models.BooleanField(default=False)
    resolved = models.BooleanField(default=False)
    created = models.DateTimeField(auto_now_add=True)
    updated = models.DateTimeField(auto_now=True)
...
class assignment_pdf_likes(models.Model):
    User = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name='assignment_pdf_likes')
    pdfAComment = models.ForeignKey(pdfAComment, on_delete=models.CASCADE)
    created = models.DateTimeField(auto_now_add=True)
    updated = models.DateTimeField(auto_now=True)
