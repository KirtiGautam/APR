...
class pdfHComment(models.Model):
    Pdf = models.ForeignKey(
        Pdf, related_name='comments', on_delete=models.CASCADE)
    Author = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name='homework_pdf_comments')
    body = models.TextField()
    likes = models.ManyToManyField(User, through='homework_pdf_likes')
    doubt = models.BooleanField(default=False)
    resolved = models.BooleanField(default=False)
    created = models.DateTimeField(auto_now_add=True)
    updated = models.DateTimeField(auto_now=True)
...
class homework_pdf_likes(models.Model):
    User = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name='homework_pdf_likes')
    pdfHComment = models.ForeignKey(pdfHComment, on_delete=models.CASCADE)
    created = models.DateTimeField(auto_now_add=True)
    updated = models.DateTimeField(auto_now=True)
