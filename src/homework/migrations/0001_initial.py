    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('viewed_by', models.ManyToManyField(related_name='user_viewed_homework_pdfs', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Test',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('viewed_by', models.ManyToManyField(related_name='user_viewed_homework_videos', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
