...
(function (root, factory) {
    ...
    */
    ...
    me.prototype.onUpdateVideoData_ = function (video_id) {
        ...
        xhr.setRequestHeader('Authorization', 'Bearer ' + this.token)
        xhr.onload = function (e) {
            this.onUpdateVideoPrivacy_(video_id)
            // add the metadata
    ...
    me.prototype.onUpdateVideoPrivacy_ = function (video_id) {

        var url = `https://api.vimeo.com/videos/${video_id}/privacy/domains/ubiqe.in`
        var httpMethod = 'PUT'
        var xhr = new XMLHttpRequest()
        xhr.open(httpMethod, url, true)
        xhr.setRequestHeader('Authorization', 'Bearer ' + this.token)
        ...
        xhr.send('privacy.embed=whitelist')
    }
