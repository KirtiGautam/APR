...
const editComment = (id) => {
  $.ajax({
    type: "GET",
    url: "/get-assignment-pdf-comment",
    data: {
      id: id,
    },
    dataType: "json",
...
const like_comment = (el) => {
  $.ajax({
    type: "POST",
    headers: { "X-CSRFToken": $('meta[name="csrf-token"]').attr("content") },
    url: "/like-assignment-pdf-comment",
    data: {
      id: el.value,
    },
    dataType: "json",
...
const delete_comment = (id) => {
  $.ajax({
    type: "POST",
    headers: { "X-CSRFToken": $('meta[name="csrf-token"]').attr("content") },
    url: "/delete-assignment-pdf-comment",
    data: {
      id: id,
    },
    dataType: "json",
...
const doubt_resolved = (id) => {
  $.ajax({
    type: "POST",
    headers: { "X-CSRFToken": $('meta[name="csrf-token"]').attr("content") },
    url: "/update-assignment-pdf-comment",
    data: {
      id: id,
      resolved: true,
    },
