...
class pdfComment(models.Model):
    ...
    Author = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name='lesson_pdf_comments')
    body = models.TextField()
    likes = models.ManyToManyField(User, through='lesson_pdf_likes')
    doubt = models.BooleanField(default=False)
    resolved = models.BooleanField(default=False)
    created = models.DateTimeField(auto_now_add=True)
    updated = models.DateTimeField(auto_now=True)
...
class lesson_pdf_likes(models.Model):
    User = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name='lesson_pdf_likes')
    pdfComment = models.ForeignKey(pdfComment, on_delete=models.CASCADE)
    created = models.DateTimeField(auto_now_add=True)
    updated = models.DateTimeField(auto_now=True)
